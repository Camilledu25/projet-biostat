...
confint(reslog)
```
$\hat \mu$= -0.88265, $\hat \beta_1$=-0.1315. 
Augmenter l'imc de 1 va multiplier l'odds d'avoir une MCC par au moins $\exp(-0.09488249)=$ 0.90 et au plus $\exp(0.0677505)=1.07009$.  \
