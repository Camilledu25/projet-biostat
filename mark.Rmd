...
coeurcox<-coeur%>%dplyr::select(-id,-dateEntree,-dateSortie,-dateNaissance,-statut,-hauteConsomation,-moisEnqu_e)
 library(survival)
  survie=Surv(coeur2$date_entree_num,coeur2$date_sortie_num,coeur$MCC)
 res=coxph(survie~coeur$taille,id=coeur$id)
res
```
...
coeurcox<-coeur%>%dplyr::select(-id,-dateEntree,-dateSortie,-dateNaissance,-statut,-hauteConsomation,-moisEnqu_e)
 library(survival)
  survie=Surv(coeur2$date_entree_num,coeur2$date_sortie_num,coeur$MCC)
 res=coxph(survie~coeur$imc,id=coeur$id)
res
```
...
coeurcox<-coeur%>%dplyr::select(-id,-dateEntree,-dateSortie,-dateNaissance,-statut,-hauteConsomation,-moisEnqu_e)
 library(survival)
  survie=Surv(coeur2$date_entree_num,coeur2$date_sortie_num,coeur$MCC)
 res=coxph(survie~coeur$consommation,id=coeur$id)
res
```
```{r}
coeurcox<-coeur%>%dplyr::select(-id,-dateEntree,-dateSortie,-dateNaissance,-statut,-hauteConsomation,-moisEnqu_e)
 library(survival)
  survie=Surv(coeur2$date_entree_num,coeur2$date_sortie_num,coeur$MCC)
 res=coxph(survie~coeur$emploi,id=coeur$id)
res
```
...
coeurcox<-coeur%>%dplyr::select(-id,-dateEntree,-dateSortie,-dateNaissance,-statut,-hauteConsomation,-moisEnqu_e)
 library(survival)
  survie=Surv(coeur2$date_entree_num,coeur2$date_sortie_num,coeur$MCC)
 res=coxph(survie~coeur$taille+coeur$poids,id=coeur$id)
res
```
